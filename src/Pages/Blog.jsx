            ...
            <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-4 container mx-auto">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <h3 className="text-2xl font-semibold mb-6">How to Start an Event Planning Service</h3>
                        <div className="flex gap-5 text-[#403F3F] text-base mb-6">
                            <p>AUG 5, 2015 <span>|</span></p>
                            <p>Admin</p>
                        </div>

                        <h3 className="text-2xl font-semibold mb-6">Turning a Profit in the Event Planning Business</h3>
                        <div className="flex gap-5  text-[#403F3F] text-base mb-6">
                            <p>AUG 5, 2015 <span>|</span></p>
                            <p>Admin</p>
                        </div>

                        <h3 className="text-2xl font-semibold mb-6">Hiring an Events Planner</h3>
                        <div className="flex gap-5 text-[#403F3F] text-base mb-6">
                            <p>AUG 5, 2015 <span>|</span></p>
                            <p>Admin</p>
                        </div>
                    ...
                    <div>
                        <h1 className="text-2xl font-semibold my-6">Popular</h1>
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mt-6">
                    ...
                    <div>
                        ...
                        <div >
                           ...
                           <div>
                           <h3 className="text-xl font-semibold mb-4">How to Start an Event Planning Service</h3>
                            <p className="flex text-xl text-pink-400"><AiOutlineStar></AiOutlineStar><AiOutlineStar></AiOutlineStar><AiOutlineStar></AiOutlineStar><AiOutlineStar></AiOutlineStar><AiOutlineStar></AiOutlineStar></p>
                           </div>
                            </div>
