    ...
    return (
        <div>
            ...
            <div className="container mx-auto">
                <h1 className="text-3xl font-bold text-center text-pink-400 mt-16 mb-7 px-3">Select Your Package</h1>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-3 lg:px-5 gap-10 mb-16">

                    {/* 1st package */}
                    <div className="bg-[#FFFF] shadow-xl rounded-lg lg:px-5 pt-3">
                        <div className="flex justify-between items-center">
                            ...
                            <div>
                                ...
                                <p className="text-pink-600 font-medium">$500 - $800/-</p>
                            </div>
                        </div>
...
{/* 2nd package */}
                    <div className="bg-[#FFFF] shadow-xl rounded-lg lg:px- pt-3">
                        <div className="flex justify-between items-center">
                            <h3 className="text-xl font-bold lg:px-5">Botanic Booking <br /> Assistance</h3>
                            <div>
                                <p className="text-base text-[#403F3F]">Starting from</p>
                                <p className="text-pink-600 font-medium">$1000 - $1200/-</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-[#FFFF] shadow-xl rounded-lg lg:px- pt-3">
                        <div className="flex justify-between items-center">
                            ...
                            <div>
                                <p className="text-base text-[#403F3F]">Starting from</p>
                                <p className="text-pink-600 font-medium">$3000 - $3200/-</p>
                            </div>
                        </div>
